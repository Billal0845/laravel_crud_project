...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="container">
        <a href="/" class="block text-white p-2 rounded bg-green-500  font-bold underline mb-5 hover:text-pink-200"><-- Go to home</a>

        <form action="{{route('store')}}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-6">
          @csrf
            <div>
